...
!(function () {
  ...
  var getModal = function (event) {
     ...
     * Additionally require that link target hash doesn't contain slashes,
     * which would indicate a vue-router path instead.
     */
    if (modalToggle && modalToggle.hash && modalToggle.hash.indexOf('/') == -1) {
  ...
  /**
   * Stephen Koo (August 11, 2017):
   * Support desktop environment with the click event in addition to touchend.
   */
  var maybeHandleModalToggle = function (event) {
  ...
  window.addEventListener('touchend', maybeHandleModalToggle);
  window.addEventListener('click', maybeHandleModalToggle);
